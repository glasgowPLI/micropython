...
#define MICROPY_ENABLE_EXTERNAL_IMPORT      (0)//(1)
#define MICROPY_PY_SYS                      (0)//(1)
#define MICROPY_PY_SYS_MAXSIZE              (1)
#define SSIZE_MAX                           INT_MAX
#define MICROPY_PY_SYS_ARGV                 (0)
#define MICROPY_PY_SYS_MODULES              (0)
#define MICROPY_PY_IO                       (0)
#define MICROPY_PY_BUILTINS_MEMORYVIEW      (0)//(1)
...
//#define MICROPY_PY_TIME_INCLUDEFILE         "ports/cheriot-rtos/modtime.c"
